...
if __name__ == '__main__':
    ...
    # Manuell die Argumente setzen
    #args.input_file = "/home/abraxas/Desktop/tiles/tile_1.tif"
    #args.output_file = "/home/abraxas/Desktop/Bitz_singular/output/result1.sqlite"
    #args.model = ["/home/abraxas/Training/models/Britz_7_final_model.pt"]
    #args.device = "cuda"
    #args.width = 128
    #args.red = 0
    #args.nir = 0
    ...
    #args.min_dist = 0
    #args.sigma = 0.1
    #args.label_threshold = 0.01
    #args.binary_threshold = 0.01
    #args.simplify = 0.1
    #args.divisor = 1.0
    #args.rescale_ndvi = False
    #args.save_prediction = None
    #args.batchsize = 16
    #args.tilesize = 0
        ...
        for i, y in enumerate(range(0, height, chunk_size)):
            for j, x in enumerate(range(0, width, chunk_size)):
                ...
                result = utils.predict_on_array_cf(model,
                                                   data,
                                                   in_shape=(nbands, args.width,# + args.ndvi
                                                   args.width),
                                                   out_bands=3,
                                                   drop_border=16,
